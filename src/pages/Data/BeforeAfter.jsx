export const honeycombItems = [
  {
    ...
    after: {
      detailPhoto: "public/portfolio/honeycomb/before/toolReal.jpg",
      correctiveActions:
  ...
  {
    before: {
      detailPhoto: "public/portfolio/honeycomb/before/4in1honeycomb1.jpg",
    ...
    after: {
      detailPhoto: "public/portfolio/honeycomb/before/4in1honeycomb.jpg",
  ...
  {
    before: {
      detailPhoto: "public/portfolio/honeycomb/before/before_5.jpg",
    ...
    after: {
      detailPhoto: "public/portfolio/honeycomb/after/after_5.jpg",
  ...
  {
    before: {
      detailPhoto: "public/portfolio/honeycomb/before/4in1alu.jpg",
    ...
    after: {
      detailPhoto: "public/portfolio/honeycomb/after/4in1aluG.jpg",
