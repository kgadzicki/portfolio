export const nestingData = {
  ...
  meta: {
    ...
    points_4: [
      ...
      "Possibility of manual or automated processing",
      "Identification of parts suitable for production using steel templates (manual cutting)",
      "Some templates obtained directly from the client",
      "Remaining templates designed and manufactured internally based on geometric/dimensional analyses",
